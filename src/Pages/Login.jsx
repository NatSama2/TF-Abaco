...
export function Login() {
  return (
    <main className="text-[2rem] flex flex-col">
      ...
      <section id="seccionContenido" className="flex items-center flex-col">
        ...
        <div className="bg-grisMuyClaro px-[84px] h-[250px] w-[80%] rounded-[150px] m-[5px] flex justify-center items-center grid grid-cols-5 grid-rows-3 gap-y-[5px] gap-x-[10px]">
          <div id="celda1">
